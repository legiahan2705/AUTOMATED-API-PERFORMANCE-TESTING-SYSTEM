    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      <div className="absolute inset-0 opacity-[0.05] select-none">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Ctext x='50%25' y='50%25' font-family='Arial, sans-serif' font-size='16' font-weight='bold' text-anchor='middle' dominant-baseline='middle' fill='%23658ec7' transform='rotate(-45 100 100)'%3Elegiahan%3C/text%3E%3C/svg%3E")`,
      ...
      {/* Watermark ở các góc */}
      <div className="absolute top-10 left-10 transform -rotate-45 text-[#658ec7]/20 text-lg font-bold select-none">
        legiahan
      </div>
      <div className="absolute top-10 right-10 transform rotate-45 text-[#658ec7]/20 text-lg font-bold select-none">
        legiahan
      </div>
      <div className="absolute bottom-10 left-10 transform rotate-45 text-[#658ec7]/20 text-lg font-bold select-none">
        legiahan
      </div>
      <div className="absolute bottom-10 right-10 transform -rotate-45 text-[#658ec7]/20 text-lg font-bold select-none">
        legiahan
      </div>
      
      {/* Watermark ở giữa các cạnh */}
      <div className="absolute top-1/2 left-5 transform -translate-y-1/2 -rotate-90 text-[#658ec7]/15 text-sm font-semibold select-none">
        legiahan
      </div>
      <div className="absolute top-1/2 right-5 transform -translate-y-1/2 rotate-90 text-[#658ec7]/15 text-sm font-semibold select-none">
        legiahan
      </div>
      <div className="absolute top-5 left-1/2 transform -translate-x-1/2 text-[#658ec7]/15 text-sm font-semibold select-none">
        legiahan
      </div>
      <div className="absolute bottom-5 left-1/2 transform -translate-x-1/2 text-[#658ec7]/15 text-sm font-semibold select-none">
        legiahan
      </div>
    </div>
  );
...
export default function CreateProjectDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="!w-[100vw]  !max-w-4xl !max-h-[90vh] !h-[90vh] bg-[#cae0ff] backdrop-blur-xl border-[#658ec7]/30 srounded-xl shadow-[0_0_10px_rgba(255,255,255,0.6)] relative">
        {/* Watermark overlay chỉ hiển thị khi dialog mở */}
        {isOpen && <WatermarkOverlay />}
